...
class _CompOffScreenState extends State<RequestCompOFF> with SingleTickerProviderStateMixin {
  ...
  Future<void> _selectStartDate() async {
    String? selectedDate = await KDateDialog.currentDateToPreviousDate(context: context);
