...
class PoshPolicy extends StatefulWidget {
  const PoshPolicy({Key? key}) : super(key: key);

  @override
  State<PoshPolicy> createState() => _WebViewScreenState();
}

class _WebViewScreenState extends State<PoshPolicy> {
  ...
  Future<void> fetchLeavePolicy() async {
    ...
    try {
      final res = await getPoshPolicy(context); // Assuming this returns PrivacyPolicyResponse
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const KCustomAppBar(screenTitle: 'Posh Policy'),
