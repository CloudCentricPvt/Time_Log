...
class LeavesPolicyScreen extends StatefulWidget {
  const LeavesPolicyScreen({Key? key}) : super(key: key);

  @override
  State<LeavesPolicyScreen> createState() => _WebViewScreenState();
}

class _WebViewScreenState extends State<LeavesPolicyScreen> {
  ...
  Future<void> fetchLeavePolicy() async {
    ...
    try {
      final res = await leavePolicy(context); // Assuming this returns PrivacyPolicyResponse
